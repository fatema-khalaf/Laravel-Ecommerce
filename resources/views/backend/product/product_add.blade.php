...
<div class="container-full">
    ...
    <x-address title='Manage Products' route='admin/dashboard' page='Products' subpage='Add Product' />
    <!-- Main content -->
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <h5>Product Size An <span class="text-danger">*</span></h5>
                                                <div class="controls">
...
{{-- new idea display multi image once selected --}}
<script type="text/javascript">
      ...
      if (window.File && window.FileReader && window.FileList && window.Blob) //check File API supported browser
      {
          ...
          $.each(data, function(index, file){ //loop though each file
              if(/(\.|\/)(gif|jpe?g|png)$/i.test(file.type)){ //check supported file type
                  ...
                  $('#preview_img').html(''); //clear pre selected images
                  return function(e) {
