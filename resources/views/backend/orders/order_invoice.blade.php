    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                ...
                <h2 style="color: green; font-size: 26px;"><strong>Pro-Ecommerce</strong></h2>
            </td>
            <td align="right">
                <pre class="font">
               Pro-Ecommerce Head Office
               Email:support@proecommerce.com <br>
               Mob: 1245454545 <br>
               Turky 1207,Istanbul:#4 <br>
