                                                ...
                                                <div class="controls">
                                                    ...
                                                    <fieldset>
                                                        <input type="checkbox" id="checkbox_10" name="returnOrders"
                                                            value="1" {{ $adminuser->returnOrders == 1 ? 'checked' : ''
                                                        }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <fieldset>
                                                        <input type="checkbox" id="checkbox_15" name="users" value="1"
                                                            {{ $adminuser->users == 1 ? 'checked' : '' }}>
                                                        <label for="checkbox_15">All user</label>
                                                    </fieldset>

                                                    <fieldset>
                                                        <input type="checkbox" id="checkbox_16" name="adminRole"
                                                            value="1" {{ $adminuser->adminRole == 1 ? 'checked' : ''
                                                        }}>
