...
<div class="container-full">
    ...
    <x-address title='Manage Admins' route='admin/dashboard' page='Admins Role' subpage='All Admins Role' />
    <!-- Main content -->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($item->adminRole == 1)
                                            <span class="badge btn-dark">Admin role</span>
                                            @else
                                            @endif
                                        </td>
                                        <td width="25%">
                                            <a href="{{ route('edit.admin',$item->id) }}" class="btn btn-info"
                                                title="Edit Data"><i class="fa fa-pencil"></i>
                                            </a>

                                            <a href="{{ route('delete.admin',$item->id) }}" class="btn btn-danger"
                                                title="Delete admin" id="delete">
