...
<div class="container-full">
    ...
    <x-address title='Manage Blog' route='admin/dashboard' page='Blog Posts' subpage='Edit Post' />
    <!-- Main content -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="post_title_en" class="form-control"
                                                        required="" value="{{$post->post_title_en}}">
                                                    @error('post_title_en')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="post_title_ar" class="form-control"
                                                        required="" value="{{$post->post_title_ar}}">
                                                    @error('post_title_ar')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                    <img src="{{ asset($post->post_image) }}" id="mainThmb">
                                                </div>
                                            </div>
                                        </div> <!-- end col md 6 -->
                                    </div> <!-- end 6th row  -->
